...
The Core AI Engine is split in two main services:

- [Core AI Engine Backend](#backend) - The API to register services and create
  pipelines
- [Core AI Engine Frontend](#frontend) - The user interface to interact with the
  backend

Another service is available, [GlitchTip](../explanations/about-glitchtip.md),
to centralize the logging errors thrown by the Core AI Engine and its services.

## Backend

The Core AI Engine Backend is built using Python 3.11, FastAPI, SQLModel and
...
This diagram represents the current version of the Core AI Engine. A future and
...
!!! info
    ...
    Check the
    [**Start the Core AI Engine locally > Start the Core AI Engine locally with plain Python and Node.js**](#start-the-core-engine-locally)
...
# Build the Core AI Engine Frontend
npm run build
```
...
The Core AI Engine Frontend is available on <http://localhost:3000>.
...
- Start the Core AI Engine locally with Docker Compose (recommended)
- Start the Core AI Engine locally with plain Python and Node.js
- Start the Core AI Engine locally with minikube and official Docker images
- Start the Core AI Engine locally with minikube and local Docker images
...
=== "minikube and local Docker images"
    ...
    !!! warning
        ...
        The Core AI Engine Backend StatefulSet (`core-engine.stateful.yml` file) must be
    ...
    # Optional: Edit the environment variables to change the Core AI Engine URL
    vim .env
