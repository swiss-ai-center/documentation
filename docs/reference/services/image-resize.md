...
- [:material-test-tube: Staging](https://image-resize-swiss-ai-center.kube.isc.heia-fr.ch/docs)
- [:material-factory: Production (not available yet)](https://image-resize.swiss-ai-center.ch/docs)
