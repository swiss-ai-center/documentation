...
[`.env`](https://github.com/swiss-ai-center/average-shade/blob/main/.env) file.

The environment variables can be overwritten during the CI/CD pipeline described
in the
[`average-shade.yml`](https://github.com/swiss-ai-center/average-shade/blob/main/.github/workflows/average-shade.yml)
...
run the tests, use the following command inside the `average-shade` folder:
...
docker build -t ghcr.io/swiss-ai-center/average-shade-service:latest .
