...
- [:material-test-tube: Staging](https://image-blur-swiss-ai-center.kube.isc.heia-fr.ch/docs)
- [:material-factory: Production (not available yet)](https://image-blur.swiss-ai-center.ch/docs)
